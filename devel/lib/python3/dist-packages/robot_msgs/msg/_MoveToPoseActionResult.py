...
"""autogenerated by genpy from robot_msgs/MoveToPoseActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveToPoseActionResult(genpy.Message):
  _md5sum = "7953129f1126313deda8a1a8467dc8ae"
  _type = "robot_msgs/MoveToPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_msgs/MoveToPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = robot_msgs.msg.MoveToPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_msgs.msg.MoveToPoseResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B2f().pack(_x.result.success, _x.result.distance_error, _x.result.angle_error))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.success, _x.result.distance_error, _x.result.angle_error,) = _get_struct_B2f().unpack(str[start:end])
